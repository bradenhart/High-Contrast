...
public final class Constants {
    ...
    public static final String setUpDefault = "welcome";
    public static final String stageWelcome = "welcome";
    public static final String stageSocial = "social";
    public static final String stageSettings = "settings";
    public static final String stageCompleted = "completed";
